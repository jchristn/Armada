...
```json
{
  ...
  "properties": {
    ...
    "model": { "type": ["string", "null"], "description": "Optional runtime-specific model override. Omit it or pass null to use the runtime default" },
...
| `model` | string \| null | No | Optional runtime-specific model override. Omit it or pass null to use the runtime default |
...
```json
{
  ...
  "properties": {
    ...
    "model": { "type": ["string", "null"], "description": "New runtime-specific model override. Omit it or pass null to use the runtime default" },
...
| `model` | string \| null | No | New runtime-specific model override. Omit it or pass null to use the runtime default |
