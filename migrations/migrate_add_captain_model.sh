...
echo "This field stores an optional model identifier that is"
echo "passed to the agent runtime on invocation."
echo ""
...
echo ""
echo "Set the model via the dashboard, REST API, or MCP tools"
echo "to override the default model for a captain's agent runtime."
