    ...
    public class ModelEndpointMethods : IModelEndpointMethods
    {
        ...
        private static ModelEndpoint EndpointFromReader(SqliteDataReader reader)
        {
            ModelEndpoint endpoint = new ModelEndpoint
            {
                ...
                Region = SqliteDatabaseDriver.NullableString(reader["region"]),
                Project = SqliteDatabaseDriver.NullableString(reader["project"]),
                ApiVersion = SqliteDatabaseDriver.NullableString(reader["api_version"]),
                AccessKeyId = SqliteDatabaseDriver.NullableString(reader["access_key_id"]),
