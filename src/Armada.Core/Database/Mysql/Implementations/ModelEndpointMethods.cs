    ...
    public class ModelEndpointMethods : IModelEndpointMethods
    {
        ...
        private static ModelEndpoint EndpointFromReader(MySqlDataReader reader)
        {
            ModelEndpoint endpoint = new ModelEndpoint
            {
                ...
                Region = MysqlDatabaseDriver.NullableString(reader["region"]),
                Project = MysqlDatabaseDriver.NullableString(reader["project"]),
                ApiVersion = MysqlDatabaseDriver.NullableString(reader["api_version"]),
                AccessKeyId = MysqlDatabaseDriver.NullableString(reader["access_key_id"]),
