      ...
      {showForm && (
        <div className="modal-overlay" onClick={() => setShowForm(false)}>
          <form className="modal" onClick={e => e.stopPropagation()} onSubmit={handleSubmit}>
            ...
            <label title="Optional runtime-specific model override. Leave blank to let the selected runtime choose its default model.">
              Model
              <input value={form.model} onChange={e => setForm({ ...form, model: e.target.value })} placeholder="e.g., gpt-5.4" />
            </label>
