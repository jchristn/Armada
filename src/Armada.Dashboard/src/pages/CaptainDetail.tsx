  ...
  return (
    <div>
      ...
      {showForm && (
        <div className="modal-overlay" onClick={() => setShowForm(false)}>
          <form className="modal" onClick={e => e.stopPropagation()} onSubmit={handleSubmit}>
            ...
            <label title="Optional AI model override. Leave blank to use the runtime default.">
              Model
              <input value={form.model} onChange={e => setForm({ ...form, model: e.target.value })} placeholder="e.g., claude-sonnet-4-20250514 (blank = runtime default)" />
            </label>
      ...
      <div className="detail-grid">
        ...
        <div className="detail-field"><span className="detail-label">Model</span><span>{captain.model || <span className="text-dim">Default</span>}</span></div>
      </div>
